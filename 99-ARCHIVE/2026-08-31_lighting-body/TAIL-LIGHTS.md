...
### Integrate
- [ ] **TL-17** Migrate on the normal per-circuit loop, [`../electrical-pmu/05-BUILD/MIGRATION-LOG.md`](../../02-PROJECTS/electrical-pmu/04-BUILD/MIGRATION-LOG.md) second pass
...
**Current drops.** LED replaces incandescent — see [`LOADS.md`](../../02-PROJECTS/electrical-pmu/01-DESIGN/LOADS.md). Update the
...
buckets — `V-066`, confirm round vs rectangular on this car (`T-035`); [`LOADS.md`](../../02-PROJECTS/electrical-pmu/01-DESIGN/LOADS.md) records LED housings as currently fitted, so one of the two files is wrong.
