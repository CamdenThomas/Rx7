...
| [`Luxury/2026-09-07_prose-before-data/`](Luxury/2026-09-07_prose-before-data/) | The luxury package's seven hand-written design documents (DCU-CLUSTER, CLUSTER-DESIGN, ICU-CARRIER, DCU-CARRIER, BENCH-BRINGUP, FORWARD-WORK, CAN-MESSAGES) as they stood before the project moved to data + templates (luxury D-309) — several claims already stale when archived | [`luxury-package/`](../02-PROJECTS/luxury-package/README.md) — rendered from `data/` and `templates/`; the stale list is its `QUESTIONS.md` §0 A3 |
| [`Luxury/2026-09-07b_icu-to-electrical/`](Luxury/2026-09-07b_icu-to-electrical/) | The luxury package's ICU-carrier template and its ten observer-front-end sensor rows (luxury D-310), as they stood when the ICU became the electrical build's device (electrical D-258 / D-259, luxury D-313) | [`electrical-build/01-DESIGN/ICU-CARRIER.md`](../02-PROJECTS/electrical-build/01-DESIGN/ICU-CARRIER.md) — rendered from `data/icu_channels.csv`; the ICU excites the senders, so there is no observer |
