...
| [`2026-08_rx7-pmu-build-checklist-revA.html`](2026-08_rx7-pmu-build-checklist-revA.html) | Rev A build checklist, generated view, three-digit step numbers | [`CHECKLIST.md`](../02-PROJECTS/electrical-pmu/04-BUILD/CHECKLIST.md) — phase.step numbering |
...
| [`2026-08_infotainment-options-considered.md`](2026-08_infotainment-options-considered.md) | Hidden Bluetooth module, ANCS turn-by-turn, three Raspberry Pi architectures, offline OSM minimap | [`HEAD-UNIT.md`](HEAD-UNIT.md) — a double-DIN head unit (D-051). The Pi minimap is buildable later if offline ever matters |
...
| [`2026-08-30_audit-4-findings.md`](2026-08-30_audit-4-findings.md) | The 95-item Audit 4 list as written, before anything was fixed | [`AUDITS.md`](../02-PROJECTS/electrical-pmu/05-PROCESS/AUDITS.md) §4 — the same items with results |
