...
| ICU | 0.4.0-dev | 2026-08-30 | Canvas 800×480 → 1280×480 (F-011, D-193); framebuffer to EXTMEM/PSRAM with boot check; BT817 driver `bt817.h` (F-008, timings flagged V-084); suite 415 + BT817 driver 35, all green | ☐ |
| ICU | | | | ☐ |
| DCU | 0.1.0-dev | 2026-08-30 | F-001 skeleton: climate/comfort logic in `climate.h` (desktop-tested, 33 green), SD memory + CRC, CAN at 5/2 Hz, seat interlock D-073 | ☐ |
| DCU | | | | ☐ |
