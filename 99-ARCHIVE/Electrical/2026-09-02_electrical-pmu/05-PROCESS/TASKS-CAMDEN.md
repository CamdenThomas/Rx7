...
| **T-035** | **Confirm 7-inch round or rectangular sealed beams** on this car, and what is actually fitted today | `V-066` | Whether the headlamp needs an adapter plate; settles the [`../01-DESIGN/LOADS.md`](../01-DESIGN/LOADS.md) vs [`TAIL-LIGHTS.md` (archived)](../../../99-ARCHIVE/Electrical/2026-08-31_lighting-body/TAIL-LIGHTS.md) disagreement |
...
The build-phase steps (TL-1 … TL-19) are [`TAIL-LIGHTS.md` (archived)](../../../99-ARCHIVE/Electrical/2026-08-31_lighting-body/TAIL-LIGHTS.md) §4.
