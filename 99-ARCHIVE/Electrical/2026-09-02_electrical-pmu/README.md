...
[`TAIL-LIGHTS.md`](../../99-ARCHIVE/Electrical/2026-08-31_lighting-body/TAIL-LIGHTS.md)
...
| *(lighting design — archived, D-204)* [`TAIL-LIGHTS.md`](../../99-ARCHIVE/Electrical/2026-08-31_lighting-body/TAIL-LIGHTS.md) | **Deferred** (L-004) — tail lights (TL-1 … TL-19), headlamp sourcing; kept in `99-ARCHIVE/` until the second pass starts |
...
| Lighting & body second pass (deferred) | DECISIONS §Lighting + OPEN §8 + BOM Wave 5; design archived — [`TAIL-LIGHTS.md`](../../99-ARCHIVE/Electrical/2026-08-31_lighting-body/TAIL-LIGHTS.md) (D-204) |
