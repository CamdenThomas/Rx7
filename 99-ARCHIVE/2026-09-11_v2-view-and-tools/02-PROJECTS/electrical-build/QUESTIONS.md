...
> **2026-09-08 · clean.** R7 citations fixed in 18 cells (D-221 → D-233, D-227 / D-231 → D-244) · NG-202 dropped from L003 · 15 data cells stripped of Markdown · DESIGN.md gets a Contents line · QUESTIONS.md §1 count is now derived and its cart claim corrected · Q-140 opened: four §1 packets move Amazon lines P049 / P052 before the carts are paid *(Q-140)*

> **2026-09-08 · answers.** D-283 closes Q-133 — the three sill holders (46047) are fitted empty on F8 / F9 / F14, so no conductor ends bare: P002 raises 4 → 7, the luxury package's LP37 / PV44 / PV45 bring fuses, not holders *(D-283 Q-133)*
...
- [ ] **A5 · Do `T-017`** (the factory pin letters) — the sender and switch letters still matter; the cluster plug's no longer do (D-268). This desk check gates no cart; four §1 packets do, and `Q-140` asks whether to rule them before paying.
...
**Q-140 · The four carts are ready to pay, but four open §1 packets would change what is in them** *(2026-09-08)*
...
|---|---|---|
| `Q-133` | D-283 | **Yes — three 46047 holders fitted empty at the sill (F8 / F9 / F14)**; P002 raises to 7, the luxury package brings fuses, not holders |
...
| ID | Closed by | Outcome |
|---|---|---|
| `Q-102` | D-244 | **The gauge is the controller and stays**, hidden behind the dash on F20, publishing AFR on **CAN2** — the PMU logs it from first start, the ICU displays it later, neither is "first". No engine-leg pair; L1-S2 9/10 stay plugged. **Supersedes D-227 → D-244 and D-231 → D-244** |
...
| `V-028` | D-225 | D-225 |
| `V-001` | D-226 | D-226 |
| `Q-100` | D-227 → D-244 | Closed by D-227 → D-244 |
| `V-097` | D-228 | D-228 |
| `V-093` | D-229 | D-229 |
...
| `V-074` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-047` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-069` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-087` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-089` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-090` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-091` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-092` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-096` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-038` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-021` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `V-019` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `A-010` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `A-012` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
| `A-013` | closed | Answered by the design as built (D-215, D-216, D-218, D-219, D-221 → D-233) or turned into an install step |
