...
| Colour | Family |
|---|---|
| **RED** | Power — every PMU output at 12 and 16 AWG, every fused feed, the K11 constant bus, the backbone |
| **ORN** | 15 A PMU outputs — the 14 AWG runs (O6–O11 and the K12 washer feed) |
| **BLK** | Ground |
| **GRY** | Analog inputs — ladders, senders, lamp-sense, sensor pass-throughs |
| **BLU** | Commands — wake sources, relay-coil returns, window commands |
| **PNK** | Switch supply from F3 (+12 V always) and the +5 V reference |
| **YEL / GRN** | CAN high / low — both buses, hand-twisted pairs |
| **shielded** | Tachometer pulse, drain grounded at the dash node only |
