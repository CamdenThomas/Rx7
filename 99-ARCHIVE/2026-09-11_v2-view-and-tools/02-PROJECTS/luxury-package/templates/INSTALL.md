...
Mirrors: uncap `D1 / D2 4–7` in the doors, land the motors and heater, splice `L4-S2 1–5` onto `D1 / D2 4–6` at the sill node, drop the fuse into F14's holder on `L4-P 4` (fitted empty by the electrical build, D-283). Windows: regulators and motors to `D1 / D2 1–2`, populate K5–K8 and fuse F8 / F9 in their fitted holders at the sill, uncap `L3-S2 3–6` at the console switches, enable the window logic in the PMU.
