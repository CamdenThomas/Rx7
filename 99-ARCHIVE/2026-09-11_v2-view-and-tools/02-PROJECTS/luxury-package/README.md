...
|---|---|
| Features | 34 |
| — by state | built 1 · built (volatile) 1 · concept 6 · criteria set 1 · design first 1 · designed 11 · moved (electrical, D-259) 6 · moved (electrical, D-268) 1 · open 1 · provisioned 1 · reserved 1 · sourcing 3 |
| Provisions consumed from the electrical build | 88 |
| CAN messages / fields | 13 / 74 |
| Sensor and output channels specified | 7 |
| Parts lines / estimate | 35 / ~$1,422–3,438 |
