...
rem   rx7 ask [project] [--all]  -> writes ANSWERS.md, the one file you type in;  rx7 answers  applies it
...
if /i "%~1"=="ask"      python tools\rx7.py ask %2 %3 & goto :eof
if /i "%~1"=="take"     python tools\rx7.py take & goto :eof
