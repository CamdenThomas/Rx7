...
**Latest:** **D-300 The three assumed `stats.h` figures are confirmed as assumed: redline… · D-303 Three Teensy 4.1 are in hand with headers; availability is not a… · D-304 The tach signal is 2 pulses per crankshaft revolution, taken from the… · D-305 Mirrors do adjustment and heat, and nothing else** (2026-09-03) · **D-306 The ICU joins early, headless: a carrier with the analog front end, the… · D-307 Blower speed is the DCU's command and the PMU's PWM: the DCU sends a… · D-308 The blower's PWM is the final stage's, not the PMU's: the DCU carrier… · D-309 The luxury record is data, rendered — the same workflow as the… · D-310 Every ICU sender input is a high-Z observer of a gauge-driven node… · D-311 `firmware/pmu_sim/channels.h` is rendered by this project's build from… · D-312 The install plan is nine stages, S0 bench → S1 ICU headless → S2… · D-313 The ICU is handed to the electrical build: carrier H-001, its channels… · D-314 The display goes in with the ICU, by the electrical build; this project…** (2026-09-07) · **D-315 The release solenoids exist and the harness reaches them; every other…** (2026-09-08). Next: D-317.

## Contents

The boundary — what the electrical build hands over · Modules — DCU and ICU · The cluster · Comfort, mirrors, windows, seats · Head unit and audio · Lighting — the second pass · Money — from the archived BOM · The record itself
...
*No standing decision under this system.*
