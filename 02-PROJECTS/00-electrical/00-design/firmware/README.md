...
*Rev 2026-09-22 · lives in `00-electrical` with both modules since D-374 (it was `01-luxury/firmware/`) · owns: cluster layout, palette, rendering, CAN structs and the automated trip figures — in code. This README is the folder map and the build instructions.*
...
compiles every `.cpp` it finds there and will try to build the SDL host for
ARM.
