...
*Rev 2026-08-30 · owns: every documentation audit of this project — findings (I-###), what was done about each, and the standing rules that came out of them. [`ASSISTANT.md`](../../../ASSISTANT.md) holds the rules themselves; this file holds why they exist.*
...
| **Reorganisation** | I-29 – I-31 | Numbered folders `01-DESIGN` … `07-PROCESS`; session-opening paths corrected in [`ASSISTANT.md`](../../../ASSISTANT.md) §0; `04-SUBSYSTEMS/` established as the home for self-contained designs |
...
From reading [`PARTS-CHANGES.md`](../04-SUBSYSTEMS/PARTS-CHANGES.md) and `INFOTAINMENT.md` end to end; the findings
generalised to most of the project. **I-32 … I-51 closed.**

**The root problem — append-only accretion.** [`PARTS-CHANGES.md`](../04-SUBSYSTEMS/PARTS-CHANGES.md) opened with a
...
| Group | Items | Result |
|---|---|---|
| **Accretion** | I-32 – I-34 | [`PARTS-CHANGES.md`](../04-SUBSYSTEMS/PARTS-CHANGES.md) and `INFOTAINMENT.md` rewritten clean; every file audited for UPDATE-contradicts-above |
...
| **Structure** | I-48 – I-51 | `05-BUILD/` stays one folder; [`PMU-CONFIG.md`](../01-DESIGN/PMU-CONFIG.md) and [`PANEL-LAYOUT.md`](../01-DESIGN/PANEL-LAYOUT.md) stay in `01-DESIGN/` (they *describe the thing*); `can_map.h` stays with the firmware; `lighting-body/DECISIONS.md` created with inherited D-107/110/111 keeping their IDs and local decisions as `L-###` |
...
| I-65 – I-68 | **D-160** `stats.h` thresholds recorded (three flagged `V-070`–`V-072`) · **D-162** volatile-only · **D-163** `stats.h` owns automated figures, [`LOGS.md`](../05-BUILD/LOGS.md) manual ones · **D-161** IMU class and axis convention |
...
- [x] **I-88 · P2** · Migration order is restated in [`CHECKLIST.md`](../05-BUILD/CHECKLIST.md) Phase 6 (18 items) although [`MIGRATION-LOG.md`](../05-BUILD/MIGRATION-LOG.md) "owns" it (26 rows) — CHECKLIST Phase 6 defers to [`MIGRATION-LOG.md`](../05-BUILD/MIGRATION-LOG.md)
...
- [x] **I-99 · P1** · [`BUY-LIST.md`](../06-PROCUREMENT/BUY-LIST.md) "STATUS — bench kit PURCHASED" (line 263) marks 120 Ω resistors, E24 assortment, breadboards, jumpers, board materials and the rotary switch as Bought — BUY-LIST rewritten as a record per D-140
...
- [x] **I-101 · P1** · [`CHECKLIST.md`](../05-BUILD/CHECKLIST.md) still builds the power windows — Windows provisioned only (D-131) throughout CHECKLIST; 0.3 dropped
- [x] **I-102 · P1** · [`PARTS-CHANGES.md`](../04-SUBSYSTEMS/PARTS-CHANGES.md) §3 "Cluster display — Format undecided `[Q-037]`" — PARTS-CHANGES cluster row → D-150/D-168
- [ ] **I-103 · P2** · [`DEFERRED-FEATURES.md`](../04-SUBSYSTEMS/DEFERRED-FEATURES.md) is the model for the tree — *no change* — DEFERRED-FEATURES kept as the pattern; headers everywhere follow it
...
- [x] **I-119 · P2** · Phase 2A effort is 35–55 hrs ([`TASKS-CAMDEN.md`](TASKS-CAMDEN.md)), 25–40 ([`CHECKLIST.md`](../05-BUILD/CHECKLIST.md), [`STATUS.md`](../STATUS.md) phase table), 12–20 ([`STATUS.md`](../STATUS.md) assessment) — Phase 2A = 12–20 hrs everywhere (D-166)
- [x] **I-120 · P2** · Money — One money table in [`BOM.md`](../06-PROCUREMENT/BOM.md) §1; STATUS and CHECKLIST point at it
...
- [x] **I-123 · P2** · Terminal wire range for 1.5 mm is 13–17 AWG in [`SPEC.md`](../01-DESIGN/SPEC.md) §2 and D-027/D-046, and 14–17 AWG in [`BUY-LIST.md`](../06-PROCUREMENT/BUY-LIST.md), [`BENCH-KIT.md`](../05-BUILD/BENCH-KIT.md) — 14–17 AWG with the pinout revision in SPEC §2
...
- [x] **I-138 · P4** · [`CHECKLIST.md`](../05-BUILD/CHECKLIST.md) numbering has gaps — Gaps annotated (0.3, 4.21–4.23, 5.12) with the decision that dropped them
...
- [x] **I-141 · P4** · [`TAIL-LIGHTS.md`](../../lighting-body/TAIL-LIGHTS.md) §6 lists Q-046 and Q-047 as open — TAIL-LIGHTS cites Q-046/Q-047 as closed
...
- [x] **I-149 · P3** · `lighting-body/` has decisions and no tasks, questions or status — `lighting-body/OPEN.md`, [`TASKS.md`](../../lighting-body/TASKS.md), [`BOM.md`](../06-PROCUREMENT/BOM.md) created
- [x] **I-150 · P3** · `00-CAR/` has no README — `00-CAR/README.md` created
- [x] **I-151 · P4** · Scope leakage in [`BOM.md`](../06-PROCUREMENT/BOM.md) — Lighting money in `lighting-body/BOM.md`
- [ ] **I-152 · P4** · [`PANEL-LAYOUT.md`](../01-DESIGN/PANEL-LAYOUT.md) and [`CUT-LIST.md`](../05-BUILD/CUT-LIST.md) are templates waiting on T-007 / T-008 — *no change* — Templates stay — their shape is the deliverable until T-007/T-008 fill them
...
- [x] **I-164 · P3** · A CHANGELOG — `07-PROCESS/CHANGELOG.md`; [`ASSISTANT.md`](../../../ASSISTANT.md) §7 appends to it at every close
