...
**Subtotal: roughly $540–880** ([`../06-PROCUREMENT/BOM.md`](../06-PROCUREMENT/BOM.md) owns the money).
...
## 5 · Build sequence — [`CHECKLIST.md`](../05-BUILD/CHECKLIST.md) Phase 3
...
| Ionic app baseline | Undervoltage/overvoltage warning thresholds, [`CHECKLIST.md`](../05-BUILD/CHECKLIST.md) 2.19 |
