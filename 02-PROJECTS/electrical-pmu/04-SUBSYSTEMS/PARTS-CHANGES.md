...
*Rev 2026-08 · owns: what physically changes on the car in THIS project*
...
**Not here:** anything pre-wired but deferred → `DEFERRED-FEATURES.md`.
...
Every lamp channel has 40–74% headroom on filament. See `../01-DESIGN/LOADS.md`.
...
| **Washer pump** | **`DIAGNOSE`** — not working `[K-022]` | Only if the pump itself is dead `[T-039]` | Diagnose before ordering — pump, wiring or switch |
...
| Item | Note | Status |
|---|---|---|
| **Fuel-door solenoid** | Never existed `[T-032]` | `PENDING` |
...
| **Head unit** | Double-DIN, wireless CarPlay `[Q-055]` | `PENDING` |

Heated seats, cooled seats, heated nozzles, wiper de-icer and the radar
subsystem are **pre-wired but deferred** → `DEFERRED-FEATURES.md`.
...
| Item | Why | Status |
|---|---|---|
| **Hatch latch switch** | Original broken `[T-033]` | `PENDING` |
| **Side mirrors** | Larger, heated, digital control. Factory control dead. Conductor count unconfirmed `[V-060]` | `PENDING` |
...
| All 15 factory fuses and the fuse block | Soft fuses + 13 panel fuses |
