...
describe('every screen has an address, and it round-trips', () => {
  const routes: Route[] = [
    ...
    { name: 'project', area: '00-electrical' },
    { name: 'blocks', area: '00-electrical' }, { name: 'blocks', area: '00-electrical', id: '00.29' },
    { name: 'picks', area: '01-luxury', id: 'PK021' }, { name: 'todo', area: '00-electrical', id: 'W-330b' },
    { name: 'decisions', area: '10-gui', id: 'D-405' }, { name: 'parts', area: '01-luxury' }, { name: 'run', area: '02-engine' },
